    ...
    _userRef
      ...
      _managerRef.child(managerID.value).once().then((DataSnapshot details) {
        setState(() {
          ...
          _managerDesignation = details.value["Branch"];
        });
      });
    });
  }
                              ...
                              children: [
                                ...
                                TextField(
                                  ...
                                  decoration: new InputDecoration(
                                    labelText: "Message for HOD (Optional)",
...
//        _userRef.child(widget.user.uid).child("leaves").update({'ol': count});
      await _leaveRef.child(widget.user.uid).push().set({
        'fromDate': '$_fromdate',
        'toDate': '$_todate',
        'status': 'pending',
  ...
  void _showDialog(context) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: Center(child: Text("Director Details")),
          content: Column(
